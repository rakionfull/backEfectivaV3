...
$routes->group('/api',['namespace' => 'App\Controllers'], function ($routes) {
    ...
    $routes->put('updateUser/(:any)', 'Home::updateUser/$1', ['filter' => 'authFilter']);
    $routes->delete('deleteUser/(:any)', 'Home::deleteUser/$1', ['filter' => 'authFilter']);
  ...
  $routes->post('addPlanAccion', 'EvaluacionRiesgoController::addPlanAccion',['filter' => 'authFilter']);
   ...
   $routes->get('countEstadoPlanes/(:num)','Activo::countEstadoPlanes/$1',['filter' => 'authFilter']);
