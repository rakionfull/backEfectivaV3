...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2023 a las 07:46:36
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_edit_impacto_1` (IN `idir` INT, IN `descripcion` VARCHAR(150), IN `tipo_regla` VARCHAR(150), IN `tipo_valor` VARCHAR(150), IN `comentario` VARCHAR(150), IN `estado` INT, IN `formula` VARCHAR(150), IN `id_user_updated` INT, IN `date_modify` DATETIME)   BEGIN
	update impacto_riesgo
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_edit_probabilidad_1` (IN `idpr` INT, IN `descripcion` VARCHAR(150), IN `tipo_regla` VARCHAR(150), IN `tipo_valor` VARCHAR(150), IN `comentario` VARCHAR(150), IN `estado` INT, IN `formula` VARCHAR(150), IN `id_user_updated` INT, IN `date_modify` DATETIME)   BEGIN
	update probabilidad_riesgo
	set formula=formula,descripcion=descripcion,tipo_regla=tipo_regla,tipo_valor=tipo_valor,comentario=comentario,estado=estado,id_user_updated=id_user_updated,date_modify=date_modify
	where id=idpr;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `validaPlanAccion` (IN `plan_accion` VARCHAR(150))   begin
	  SELECT * FROM plan_accion where plan_accion=plan_accion and is_deleted=0;
end$$
...
(2, 'Insignificante', '2 Valores', 'Numero', NULL, '>', 0, '<=', 3000, 'Insignificante', 1, 2, 5, '2023-03-24 08:14:38.000000', 5, '2023-03-24 08:31:19.000000', NULL, NULL, 0),
(3, 'Menor', '2 Valores', 'Numero', NULL, '>', 3000, '<=', 6500, 'Menor', 1, 2, 5, '2023-03-24 08:30:48.000000', 5, '2023-03-24 08:31:27.000000', NULL, NULL, 0),
(4, 'Moderado', '2 Valores', 'Numero', NULL, '>', 6500, '<=', 10000, 'Moderado', 1, 2, 5, '2023-03-24 08:32:06.000000', NULL, NULL, NULL, NULL, 0),
(5, 'Alto', '2 Valores', 'Numero', NULL, '>', 10000, '<=', 45000, 'Alto', 1, 2, 5, '2023-03-24 08:32:40.000000', NULL, NULL, NULL, NULL, 0),
(6, 'Catastrófico', '2 Valores', 'Numero', NULL, '>', 45000, '<=', 100000, 'Catastrófico', 1, 2, 5, '2023-03-24 08:33:16.000000', NULL, NULL, NULL, NULL, 0);
...
(1, 12, 11, 8, 1, 1, 'Activo A', 'Activo A', 1, 1, 1, 1, 1, 1, 1, 1, 1, 4, 'Activo A', '', 5, '2023-03-25 00:52:04.000000', 8, '2023-03-25 01:26:31.000000', NULL, NULL, 0);
...
(1, 'Moderado', '>', 2, '<', 4, '#e85454', 'Moderado', 1, 5, '2023-03-24 02:50:33.000000', NULL, NULL, NULL, NULL, 0);
...
(2, 'Rara', '2 Valores', 'Numero', NULL, '>', 1, '<=', 3, 'Rara', 1, 2, 5, '2023-03-24 08:13:02.000000', 5, '2023-03-24 08:29:41.000000', NULL, NULL, 0),
(3, 'Improbable', '2 Valores', 'Numero', NULL, '>', 4, '<=', 8, 'Improbable', 1, 2, 5, '2023-03-24 08:25:06.000000', 5, '2023-03-24 08:29:45.000000', NULL, NULL, 0),
(4, 'Posible', '2 Valores', 'Numero', NULL, '>', 9, '<=', 14, 'Posible', 1, 2, 5, '2023-03-24 08:25:39.000000', 5, '2023-03-24 08:29:50.000000', NULL, NULL, 0),
(5, 'Muy Probable', '2 Valores', 'Numero', NULL, '>', 15, '<=', 29, 'Muy Probable', 1, 2, 5, '2023-03-24 08:29:08.000000', NULL, '2023-03-24 08:29:08.000000', NULL, NULL, 0),
(6, 'Casi Certeza', '2 Valores', 'Numero', NULL, '>', 30, '<=', 104, 'Casi Certeza', 1, 2, 5, '2023-03-24 08:29:32.000000', NULL, '2023-03-24 08:29:32.000000', NULL, NULL, 0);
...
(28, 8, '1679725132.000000', '1679728732.000000', '2023-03-25 01:18:52.000000', 1);
...
(5, '', 'admin', 'admin', 'admin', 'prueba2@gmail.com', 'admin', '2023-03-22 00:41:33.000000', '2023-03-25 01:18:12.000000', 1, 1, 0, 1, NULL, 11, 12, 1, 11, 8, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(6, '', '', '', '', 'prueba4@gmail.com', 'testeo4', '2023-03-22 15:43:24.000000', NULL, 1, NULL, NULL, 0, NULL, 11, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(8, '', 'testeo5', 'testeo5', 'testeo5', 'admin@gmail.com', 'testeo5', '2023-03-22 15:58:17.000000', '2023-03-25 01:10:37.000000', 1, 1, NULL, 1, NULL, 14, 12, 1, 11, 8, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL);
...
--
ALTER TABLE `tb_sesiones`
  MODIFY `id_se` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
