...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-03-2023 a las 10:10:07
...
-- Procedimientos
--
CREATE  PROCEDURE `add_evaluacion_riesgos_controles` (IN `id_evaluacion_riesgo` INT, IN `id_control` INT, IN `id_user_added` INT, IN `date_add` DATETIME)   begin
...
CREATE  PROCEDURE `agregar_actividades_plan` (IN `idempresa` INT, IN `idarea` INT, IN `idunidad` INT, IN `idposicion` INT, IN `idusuario` INT, IN `descripcion` VARCHAR(150), IN `fecha_inicio` DATETIME, IN `fecha_fin` DATETIME, IN `idalerta` INT, IN `progreso` INT, IN `idUserAdd` INT, IN `idplan` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_AlertSeguimiento` (IN `alerta` VARCHAR(100), IN `valor` INT, IN `descripcion` VARCHAR(100), IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_AplicacionImpacto` (IN `disenio` INT, IN `posicion` VARCHAR(50), IN `escenario` INT, IN `descripcion` VARCHAR(100), IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_AplicacionProbabilidad` (IN `disenio` INT, IN `posicion` VARCHAR(50), IN `escenario` INT, IN `descripcion` VARCHAR(100), IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_catactivo` (IN `categoria` VARCHAR(150), IN `tipo` INT, IN `estado` INT, IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_clasinfo` (IN `clasificacion` VARCHAR(150), IN `descripcion` VARCHAR(150), IN `estado` INT, IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_cobertura` (IN `cobertura` VARCHAR(100), IN `descripcion` VARCHAR(100), IN `idUserAdd` INT)   BEGIN
	INSERT INTO cobertura  (cobertura,descripcion,id_user_added,date_add)
    VALUES (cobertura,descripcion,idUserAdd,current_date());
END$$

CREATE  PROCEDURE `agregar_detalle_control` (IN `idControl` INT, IN `idCC` INT, IN `nom_tabla` INT, IN `valor` VARCHAR(50))   BEGIN
	INSERT INTO detalle_controles(idControles, idCC, nom_tabla,valor)
	VALUES (idControl,idCC,nom_tabla,valor);
END$$

CREATE  PROCEDURE `agregar_detalle_Evaluacion_Control` (IN `IEC` INT, IN `IDCC` INT)   BEGIN
	INSERT INTO detalle_evaluacion_control(IEC,ID_CC)
    VALUES (IEC,IDCC);
END$$

CREATE  PROCEDURE `agregar_empresa` (IN `empresa` VARCHAR(150), IN `estado` INT, IN `idUserAdd` INT)   BEGIN
	INSERT INTO empresa	(empresa,estado,id_user_added,date_add) VALUES(empresa,estado,idUserAdd,now());
END$$

CREATE  PROCEDURE `agregar_estado` (IN `estado` VARCHAR(150), IN `descripcion` VARCHAR(150), IN `idUserAdd` INT)   BEGIN
	INSERT INTO estado  (estado,descripcion,id_user_added,date_add)
    VALUES (estado, descripcion,idUserAdd,current_date());
END$$

CREATE  PROCEDURE `agregar_Evaluacion_Control` (IN `calificacion` VARCHAR(50), IN `idUserAdd` INT)   BEGIN
	INSERT INTO evaluacion_control2(calificacion,id_user_added,date_add)
    VALUES (calificacion,idUserAdd,current_date());
END$$

CREATE  PROCEDURE `agregar_macroproceso` (IN `area` INT, IN `empresa` INT, IN `unidad` INT, IN `macroproceso` VARCHAR(150), IN `estado` INT, IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_posicion` (IN `area` INT, IN `empresa` INT, IN `unidad` INT, IN `posicion` VARCHAR(150), IN `estado` INT, IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_prioridad` (IN `prioridad` VARCHAR(100), IN `descripcion` VARCHAR(100), IN `idUserAdd` INT)   BEGIN
	INSERT INTO prioridad(prioridad, decripcion,id_user_added,date_add)
	VALUES (prioridad,descripcion,idUserAdd,current_date());
END$$

CREATE  PROCEDURE `agregar_proceso` (IN `area` INT, IN `empresa` INT, IN `unidad` INT, IN `macroproceso` INT, IN `proceso` VARCHAR(150), IN `estado` INT, IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_Registro_Controles` (IN `IDR` VARCHAR(100), IN `riesgo` VARCHAR(100), IN `IDC` VARCHAR(100), IN `control` VARCHAR(100), IN `cobertura` INT, IN `evaluacion` VARCHAR(100), IN `estado` INT, IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_tipoactivo` (IN `tipo` VARCHAR(150), IN `estado` INT, IN `idUserAdd` INT)   BEGIN
	INSERT INTO tipo_activo (tipo,estado,id_user_added,date_add)
VALUES (tipo,estado,idUserAdd,now());
END$$

CREATE  PROCEDURE `agregar_ubiactivo` (IN `continente` VARCHAR(50), IN `pais` VARCHAR(50), IN `ciudad` VARCHAR(50), IN `direccion` VARCHAR(300), IN `descripcion` VARCHAR(300), IN `estado` INT, IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_unidad` (IN `area` INT, IN `empresa` INT, IN `unidad` VARCHAR(150), IN `estado` INT, IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_valoracionactivo` (IN `aspecto1` INT, IN `aspecto2` INT, IN `aspecto3` INT, IN `valoracion1` INT, IN `valoracion2` INT, IN `valoracion3` INT, IN `idvalor` INT, IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_ValoracionRiesgo` (IN `valor` VARCHAR(100), IN `probabilidad` INT, IN `impacto` INT, IN `idUserAdd` INT)   BEGIN
...
CREATE  PROCEDURE `agregar_valoractivo` (IN `valor` VARCHAR(150), IN `estado` INT, IN `idUserAdd` INT)   BEGIN
	INSERT INTO valor_activo(valor,estado,
id_user_added,date_add) VALUES(valor,estado,idUserAdd,now());
END$$

CREATE  PROCEDURE `editar_area` (IN `area` VARCHAR(150), IN `empresa` INT, IN `estado` INT, IN `idarea` INT, IN `idUserAdd` INT)   begin
	update area  
...
CREATE  PROCEDURE `editar_aspecto` (IN `aspecto` VARCHAR(150), IN `idaspecto` INT, IN `estado` INT, IN `idUserAdd` INT)   begin
...
CREATE  PROCEDURE `editar_catactivo` (IN `categoria` VARCHAR(150), IN `idcategoria` INT, IN `tipo` INT, IN `estado` INT, IN `idUserAdd` INT)   begin
...
CREATE  PROCEDURE `editar_clasinfo` (IN `idclasi` INT, IN `clasificacion` VARCHAR(150), IN `descripcion` VARCHAR(150), IN `estado` INT, IN `idUserAdd` INT)   begin
...
CREATE  PROCEDURE `editar_empresa` (IN `empresa` VARCHAR(150), IN `estado` INT, IN `idempresa` INT, IN `idUserAdd` INT)   begin
	update empresa 
...
CREATE  PROCEDURE `editar_macroproceso` (IN `area` INT, IN `empresa` INT, IN `unidad` INT, IN `macroproceso` VARCHAR(150), IN `estado` INT, IN `idmacroproceso` INT, IN `idUserAdd` INT)   begin
	update macroproceso   
	set 
    idarea=area,
    idempresa=empresa,
...
CREATE  PROCEDURE `editar_plan_accion` (IN `id` INT, IN `id_riesgo` VARCHAR(150), IN `id_control` VARCHAR(150), IN `plan_accion` VARCHAR(150), IN `descripcion` VARCHAR(150), IN `fecha_inicio` DATE, IN `fecha_fin` DATE, IN `id_user_updated` INT)   BEGIN
	UPDATE plan_accion
...
CREATE  PROCEDURE `editar_posicion` (IN `area` INT, IN `empresa` INT, IN `unidad` INT, IN `posicion` VARCHAR(150), IN `idposicion` INT, IN `estado` INT, IN `idUserAdd` INT)   begin
...
CREATE  PROCEDURE `editar_proceso` (IN `area` INT, IN `empresa` INT, IN `unidad` INT, IN `macroproceso` INT, IN `proceso` VARCHAR(150), IN `idproceso` INT, IN `estado` INT, IN `idUserAdd` INT)   begin
	update proceso   
	set 
    idarea=area,
idempresa=empresa,
...
CREATE  PROCEDURE `editar_tipoactivo` (IN `tipo` VARCHAR(150), IN `idtipo` INT, IN `estado` INT, IN `idUserAdd` INT)   begin
...
CREATE  PROCEDURE `editar_ubiactivo` (IN `idubiactivo` INT, IN `continente` VARCHAR(50), IN `pais` VARCHAR(50), IN `ciudad` VARCHAR(50), IN `direccion` VARCHAR(300), IN `descripcion` VARCHAR(300), IN `estado` INT, IN `idUserAdd` INT)   begin
...
CREATE  PROCEDURE `editar_unidad` (IN `area` INT, IN `empresa` INT, IN `unidad` VARCHAR(150), IN `estado` INT, IN `idunidad` INT, IN `idUserAdd` INT)   begin
	update unidades  
	set idarea=area,
    idempresa=empresa,
    unidad=unidad,
...
CREATE  PROCEDURE `editar_valoracionactivo` (IN `aspecto1` INT, IN `aspecto2` INT, IN `aspecto3` INT, IN `valoracion1` INT, IN `valoracion2` INT, IN `valoracion3` INT, IN `idvalor` INT, IN `idvaloracion` INT, IN `idUserAdd` INT)   begin
...
CREATE  PROCEDURE `editar_valoractivo` (IN `valor` VARCHAR(150), IN `idvalor` INT, IN `estado` INT, IN `idUserAdd` INT)   begin
...
CREATE  PROCEDURE `eliminar_actividades_plan` (IN `id` INT, IN `idUserDel` INT)   BEGIN
...
CREATE  PROCEDURE `eliminar_alertSeguimiento` (IN `idUserAdd` INT, IN `idAlerta` INT)   BEGIN
...
CREATE  PROCEDURE `eliminar_AplicacionImpacto` (IN `idUserAdd` INT, IN `idAplicacionImpacto` INT)   BEGIN
...
CREATE  PROCEDURE `eliminar_AplicacionProbabilidad` (IN `idUserAdd` INT, IN `idAplicacionProbabilidad` INT)   BEGIN
	UPDATE aplicacion_probailidad  SET
	id_user_deleted=idUserAdd,
	date_deleted=current_date(),
	is_deleted=1
...
CREATE  PROCEDURE `eliminar_caractControl` (IN `idUserAdd` INT, IN `idCaractControl` INT)   BEGIN
...
CREATE  PROCEDURE `eliminar_cobertura` (IN `idUserAdd` INT, IN `idCobertura` INT)   BEGIN
...
CREATE  PROCEDURE `eliminar_estado` (IN `idUserAdd` INT, IN `idEstado` INT)   BEGIN
	UPDATE estado  SET
	id_user_deleted=idUserAdd,
	date_deleted=current_date(),
	is_deleted=1
...
CREATE  PROCEDURE `eliminar_Evaluacion_Control` (IN `idUserAdd` INT, IN `idEvaluacionControl` INT)   BEGIN
...
CREATE  PROCEDURE `eliminar_plan_accion` (IN `id` INT, IN `id_user_deleted` INT)   BEGIN
	UPDATE plan_accion
...
CREATE  PROCEDURE `eliminar_prioridad` (IN `idUserAdd` INT, IN `idPrioridad` INT)   BEGIN
...
CREATE  PROCEDURE `eliminar_Registro_Controles` (IN `idUserAdd` INT, IN `idControl` INT)   BEGIN
...
CREATE  PROCEDURE `eliminar_ValoracionRiesgo` (IN `idUserAdd` INT, IN `idValoracionRiesgo` INT)   BEGIN
...
CREATE  PROCEDURE `getCorreoActividadesEnviados` (IN `id` INT)   begin
	SELECT * FROM correo_actividad where idactividad= id ORDER BY id DESC LIMIT 1;
end$$

CREATE  PROCEDURE `getCorreoPlan` ()   begin
...
CREATE  PROCEDURE `getCorreoPlanEnviados` (IN `id` INT)   begin
	SELECT * FROM correo_plan where idplan= id ORDER BY id DESC LIMIT 1;
end$$

CREATE  PROCEDURE `getData2` (IN `tabla` VARCHAR(150))   begin
 SELECT * FROM tabla where is_deleted=0 and estado=1;
end$$

CREATE  PROCEDURE `getDataMatriz` ()   begin
...
CREATE  PROCEDURE `getDetalleEvaluacionControl` (IN `idid` INT)   begin
...
CREATE  PROCEDURE `getEvaluacionControl` ()   begin
select * from 
        evaluacion_control2 where is_deleted=0;
end$$

CREATE  PROCEDURE `getOpcionesCaracteristica` (IN `idtipo` VARCHAR(150))   begin
SELECT * from caracteristica_control where is_deleted=0 and estado=1 and tipo=idtipo order by date_add;
end$$

CREATE  PROCEDURE `getPaises` (IN `dato` VARCHAR(30))   begin
SELECT * FROM pais where continente=dato;
end$$

CREATE  PROCEDURE `getPlanControl` ()   begin
select * from 
        registro_controles where is_deleted=0;
end$$

CREATE  PROCEDURE `getPosicionByArea` (IN `idarea` INT)   begin
...
CREATE  PROCEDURE `getPosicionByUnidad` (IN `empresa` INT, IN `area` INT, IN `unidad` INT)   begin
	SELECT PP.id as id_pos,PP.posicion_puesto,PP.idempresa,PP.idunidad,PP.idarea,
        E.empresa,A.area,U.unidad,PP.estado FROM posicion_puesto as PP inner join empresa as E
        on PP.idempresa=E.id inner join area as A on PP.idarea=A.id 
        inner join unidades as U on PP.idunidad=U.id
...
CREATE  PROCEDURE `getRegistroControl` (IN `idid` INT)   begin
select * from registro_controles 
        where id=idid;
end$$

CREATE  PROCEDURE `getRegistroControles` ()   begin
select * from 
        registro_controles where is_deleted=0;
end$$

CREATE  PROCEDURE `getRegistroControles2` ()   begin
...
CREATE  PROCEDURE `getRegistroDetalleControl` (IN `idid` INT)   begin
select * from 
        detalle_controles where idControles=idid;
end$$

CREATE  PROCEDURE `getTabla` (IN `idid` INT)   begin
 SELECT nom_tabla FROM catalogo_tabla where id=idid;
end$$

CREATE  PROCEDURE `getTipoActivoByActivo` ()   begin
...
CREATE  PROCEDURE `getUserByDatos` (IN `user` VARCHAR(50))   BEGIN
...
CREATE  PROCEDURE `getValorActivoByActivo` ()   begin
	SELECT * FROM valor_activo where estado='1' and is_deleted=0;

end$$

CREATE  PROCEDURE `get_Plan_Control` (IN `id` INT)   BEGIN
...
CREATE  PROCEDURE `insertCorreoActividad` (IN `id` INT, IN `fecha` DATETIME, IN `usuario` INT)   begin
	INSERT INTO correo_actividad (idactividad,fecha_envio,idusuario) 
        VALUES (id,fecha,usuario);
end$$

CREATE  PROCEDURE `insertCorreoPlan` (IN `id` INT, IN `fecha` DATETIME, IN `usuario` INT)   begin
	INSERT INTO correo_plan (idplan,fecha_envio,idusuario) 
        VALUES (id,fecha,usuario);
end$$

CREATE  PROCEDURE `LastIdControles` ()   begin
SELECT MAX(id) as last_id from registro_controles;
end$$

CREATE  PROCEDURE `last_id_Evaluacion_Control` ()   BEGIN
	SELECT  id as maxid FROM evaluacion_control2 order by id desc limit 1;
END$$

CREATE  PROCEDURE `last_id_Registro_Proceso` ()   BEGIN
	SELECT  id as maxid FROM registro_controles order by id desc limit 1;
END$$

CREATE  PROCEDURE `listaCategoriaByActivo` (IN `idactivo` INT)   begin
	SELECT * FROM categoria_activo where idtipo=idactivo and is_deleted=0;
end$$

CREATE  PROCEDURE `listaProcesoByEstado` ()   begin
	SELECT * FROM proceso 
            where estado='1' ;

end$$

CREATE  PROCEDURE `listaProcesoByMacro` (IN `empresa` INT, IN `area` INT, IN `unidad` INT, IN `macroproceso` INT)   begin
...
CREATE  PROCEDURE `listarArea` ()   begin
...
CREATE  PROCEDURE `listarAreaByActivo` (IN `empresa` INT)   begin
	SELECT * FROM area 
            where estado='1' and idempresa=empresa and is_deleted=0;
end$$

CREATE  PROCEDURE `listarAreaEmpresa` (IN `dato` INT)   begin
	SELECT a.id,a.idempresa,e.empresa,a.area,a.estado
            from empresa as E inner join area as A 
			on a.idempresa = e.id where a.idempresa=dato;
end$$

CREATE  PROCEDURE `listarAspecto` ()   begin
	SELECT * FROM 
...
CREATE  PROCEDURE `listarcatactivo` ()   begin
...
CREATE  PROCEDURE `listarclasinfo` ()   begin
...
CREATE  PROCEDURE `listarEmpresa` ()   begin
	SELECT * FROM empresa where is_deleted=0;
end$$

CREATE  PROCEDURE `listarEmpresaByAcivo` ()   begin
	SELECT * FROM empresa where estado='1' and is_deleted=0;
end$$

CREATE  PROCEDURE `listarMacroEmpresa` (IN `dato` INT)   begin
...
CREATE  PROCEDURE `listarMacroproceso` ()   begin
	SELECT M.id, m.macroproceso,E.empresa,A.area,U.unidad,M.estado,M.idempresa,
            M.idarea,M.idunidad
            from macroproceso as M inner join empresa as E on M.idempresa=e.id
                                    inner join area as A on M.idarea=A.id
...
CREATE  PROCEDURE `listarMacroprocesoByActivo` (IN `empresa` INT, IN `area` INT, IN `unidad` INT)   begin
...
CREATE  PROCEDURE `listarPosicion` ()   begin
	SELECT PP.id as id_pos,PP.posicion_puesto,PP.idempresa,PP.idunidad,PP.idarea,
            E.empresa,A.area,U.unidad,PP.estado FROM posicion_puesto as PP inner join empresa as E
            on PP.idempresa=E.id inner join area as A on PP.idarea=A.id 
...
CREATE  PROCEDURE `listarPosicionEmpresa` (IN `dato` INT)   begin
	SELECT PP.id as id_pos,PP.posicion_puesto,PP.idempresa,PP.idunidad,PP.idarea,
            E.empresa,A.area,U.unidad,PP.estado FROM posicion_puesto as PP inner join empresa as E
            on PP.idempresa=E.id inner join area as A on PP.idarea=A.id 
...
CREATE  PROCEDURE `listarProceso` ()   begin
...
CREATE  PROCEDURE `listarProcesoEmpresa` (IN `dato` INT)   begin
	SELECT P.id,P.proceso,E.empresa,A.area,U.unidad,m.macroproceso,P.estado,
            P.idempresa,P.idarea,P.idunidad,P.idmacroproceso
            from proceso as P inner join empresa as E on P.idempresa=e.id
                                    inner join area as A on P.idarea=A.id
...
CREATE  PROCEDURE `listartipoactivo` ()   begin
...
CREATE  PROCEDURE `listarubiactivo` ()   begin
...
CREATE  PROCEDURE `listarUnidadByActivo` (IN `empresa` INT(12), IN `area` INT(12))   begin
...
CREATE  PROCEDURE `listarUnidadByEstado` ()   begin
SELECT * FROM unidades where estado='1';

end$$

CREATE  PROCEDURE `listarUnidadEmpresa` (IN `dato` INT)   begin
...
CREATE  PROCEDURE `listarUnidades` ()   begin
	SELECT U.id,U.unidad,E.empresa,A.area,U.estado,U.idempresa,U.idarea
            from unidades as U inner join empresa as E on U.idempresa = e.id
...
CREATE  PROCEDURE `listarValoracionActivo` ()   begin
...
CREATE  PROCEDURE `listarValorActivo` ()   begin
	SELECT * FROM 
...
CREATE  PROCEDURE `listar_actividadesByPlan` (IN `id_planes` INT)   BEGIN
	select PA.id, 
...
CREATE  PROCEDURE `listar_actividades_plan` (IN `idid` INT)   BEGIN
...
CREATE  PROCEDURE `listar_alert_seguimiento` ()   BEGIN
	SELECT * FROM alert_seguimiento where is_deleted=0;
END$$

CREATE  PROCEDURE `listar_AplicacionImpacto` (IN `idescenario` INT)   BEGIN
...
CREATE  PROCEDURE `listar_AplicacionProbabilidad` (IN `idescenario` INT)   BEGIN
	select id,idclasificacion,(select caracteristica from caracteristica_control where id=idclasificacion) as disenio,
	posicion,descripcion,escenario
...
CREATE  PROCEDURE `listar_caractControl` ()   BEGIN
	SELECT * FROM caracteristica_control where is_deleted=0;
END$$

CREATE  PROCEDURE `listar_cobertura` ()   begin
	SELECT * FROM cobertura;
end$$

CREATE  PROCEDURE `listar_detalle_plan` (IN `id` INT)   BEGIN
	select count(*) as actividades from actividades_plan where id_planes= id;
END$$

CREATE  PROCEDURE `listar_estado` ()   BEGIN
	SELECT * FROM estado where is_deleted=0;
END$$

CREATE  PROCEDURE `listar_Evaluacion_Control` ()   BEGIN
...
CREATE  PROCEDURE `listar_ImpactoRiesgoByActivo` ()   BEGIN
	SELECT *
	FROM impacto_riesgo
    where is_deleted=0 and estado=1 and tipo_regla='2 Valores'  order by valor1 ASC;
END$$

CREATE  PROCEDURE `listar_plan_accion` ()   BEGIN
...
CREATE  PROCEDURE `modificar_actividades_plan` (IN `idid` INT, IN `idempresa` INT, IN `idarea` INT, IN `idunidad` INT, IN `idposicion` INT, IN `idusuario` INT, IN `descripcion` VARCHAR(150), IN `fecha_inicio` DATETIME, IN `fecha_fin` DATETIME, IN `idalerta` INT, IN `progreso` INT, IN `idUserModify` INT)   BEGIN
	UPDATE actividades_plan SET 
        idempresa = idempresa,
        idarea = idarea,
        idunidad = idunidad,
...
CREATE  PROCEDURE `modificar_AlertSeguimiento` (IN `alerta` VARCHAR(150), IN `valor` INT, IN `descripcion` VARCHAR(150), IN `idUserAdd` INT, IN `idAlerta` INT)   BEGIN
	UPDATE alert_seguimiento  SET
	alerta=alerta,
	valor=valor,
	descripcion= descripcion,
...
CREATE  PROCEDURE `modificar_AplicacionImpacto` (IN `disenio` INT, IN `posicion` VARCHAR(50), IN `escenario` INT, IN `descripcion` VARCHAR(100), IN `idUserAdd` INT, IN `idAplicacionImpacto` INT)   BEGIN
...
CREATE  PROCEDURE `modificar_AplicacionProbabilidad` (IN `disenio` INT, IN `posicion` VARCHAR(50), IN `escenario` INT, IN `descripcion` VARCHAR(100), IN `idUserAdd` INT, IN `idAplicacionProbabilidad` INT)   BEGIN
	UPDATE aplicacion_probailidad  SET
	idclasificacion=disenio,
	posicion= posicion,
	descripcion= descripcion,
...
CREATE  PROCEDURE `modificar_caractControl` (IN `idcaracteristica` VARCHAR(100), IN `iddescripcion` VARCHAR(100), IN `idestado` INT, IN `idpeso` VARCHAR(50), IN `idvalor` VARCHAR(50), IN `idcondicion` VARCHAR(50), IN `idcheck_tabla` INT, IN `idnom_tabla` VARCHAR(100), IN `idcalificacion` INT, IN `idseleccionable` INT, IN `idUserAdd` INT, IN `idCaractControl` INT)   BEGIN
	UPDATE caracteristica_control  SET
...
CREATE  PROCEDURE `modificar_cobertura` (IN `cobertura` VARCHAR(100), IN `descripcion` VARCHAR(100), IN `idUserAdd` INT, IN `idCobertura` INT)   BEGIN
	UPDATE cobertura  SET
	cobertura=cobertura,
	descripcion= descripcion,
	id_user_updated=idUserAdd,
...
CREATE  PROCEDURE `modificar_detalle_control` (IN `idvalor` VARCHAR(50), IN `idControl` INT, IN `ididCC` INT)   BEGIN
	UPDATE  detalle_controles SET
	valor=idvalor WHERE idControles=idControl and idCC=ididCC;
END$$

CREATE  PROCEDURE `modificar_estado` (IN `estado` VARCHAR(150), IN `descripcion` VARCHAR(150), IN `idUserAdd` INT, IN `idEstado` INT)   BEGIN
	UPDATE estado  SET
	   estado=estado,
	   descripcion= descripcion,
	   id_user_updated=idUserAdd,
...
CREATE  PROCEDURE `modificar_Evaluacion_Control` (IN `calificacion` VARCHAR(50), IN `idUserAdd` INT, IN `idEvaluacionControl` INT)   BEGIN
	UPDATE evaluacion_control2  SET
...
CREATE  PROCEDURE `modificar_plan_accion` (IN `id` INT, IN `plan` VARCHAR(150), IN `descripcion` VARCHAR(150), IN `fecha_ini` DATETIME, IN `fecha_fin` DATETIME, IN `empresa` INT, IN `area` INT, IN `unidad` INT, IN `posicion` INT, IN `usuario` INT, IN `prioridad` INT, IN `estado` INT, IN `alerta` INT, IN `idUserAdd` INT, IN `idriesgo` VARCHAR(150), IN `idcontrol` VARCHAR(150))   BEGIN
...
CREATE  PROCEDURE `modificar_prioridad` (IN `prioridad` VARCHAR(150), IN `descripcion` VARCHAR(150), IN `idUserAdd` INT, IN `idPrioridad` INT)   BEGIN
	UPDATE prioridad  SET
	prioridad=prioridad,
...
CREATE  PROCEDURE `modificar_Registro_Controles` (IN `idIDR` VARCHAR(100), IN `idriesgo` VARCHAR(100), IN `idIDC` VARCHAR(100), IN `control` VARCHAR(100), IN `cobertura` INT, IN `idevaluacion` VARCHAR(100), IN `idestado` INT, IN `idUserAdd` INT, IN `idControl` INT)   BEGIN
	UPDATE  registro_controles SET
	IDR= idIDR,
	riesgo=idriesgo,
	IDC=idIDC,
...
CREATE  PROCEDURE `modificar_ValoracionRiesgo` (IN `valor` VARCHAR(100), IN `probabilidad` INT, IN `impacto` INT, IN `idUserAdd` INT, IN `idValoracionRiesgo` INT)   BEGIN
...
CREATE  PROCEDURE `obtenerPeso` (IN `idid` INT)   begin
select peso from caracteristica_control where id=idid;
end$$

CREATE  PROCEDURE `saveLog` (IN `idterminal` VARCHAR(150), IN `idip_addres` VARCHAR(150), IN `idu_ejecutor` VARCHAR(150), IN `idu_afectado` VARCHAR(150), IN `idaccion` VARCHAR(150), IN `idfecha` DATETIME)   begin
...
CREATE  PROCEDURE `saveSesion` (IN `id` INT, IN `iat` VARCHAR(150), IN `exp` VARCHAR(150), IN `activity` VARCHAR(150))   begin
...
CREATE  PROCEDURE `sp_add_categoria_vulnerabilidad` (IN `categoria` VARCHAR(150), IN `estado` INT, IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_desc_amenaza` (IN `idtipo_amenaza` INT, IN `amenaza` VARCHAR(150), IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_desc_vulnerabilidad` (IN `idcategoria` INT, IN `vulnerabilidad` VARCHAR(150), IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_evaluacion_riesgo` (IN `id_tipo_riesgo` INT, IN `id_empresa` INT, IN `id_area` INT, IN `id_unidad` INT, IN `id_macroproceso` INT, IN `id_proceso` INT, IN `id_activo` INT, IN `id_tipo_amenaza` INT, IN `id_descripcion_amenaza` INT, IN `id_tipo_vulnerabilidad` INT, IN `id_descripcion_vulnerabilidad` INT, IN `riesgo` VARCHAR(150), IN `valor_probabilidad` INT, IN `probabilidad` VARCHAR(150), IN `valor_impacto` VARCHAR(150), IN `impacto` VARCHAR(150), IN `valor` VARCHAR(150), IN `id_control` INT, IN `riesgo_controlado_probabilidad` VARCHAR(150), IN `riesgo_controlado_impacto` VARCHAR(150), IN `riesgo_controlado_valor` VARCHAR(150), IN `estado` INT, IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_evaluacion_riesgo_historial` (IN `id_tipo_riesgo` INT, IN `id_empresa` INT, IN `id_area` INT, IN `id_unidad` INT, IN `id_macroproceso` INT, IN `id_proceso` INT, IN `id_activo` INT, IN `id_tipo_amenaza` INT, IN `id_descripcion_amenaza` INT, IN `id_tipo_vulnerabilidad` INT, IN `id_descripcion_vulnerabilidad` INT, IN `riesgo` VARCHAR(150), IN `valor_probabilidad` INT, IN `probabilidad` VARCHAR(150), IN `valor_impacto` VARCHAR(150), IN `impacto` VARCHAR(150), IN `valor` VARCHAR(150), IN `id_control` INT, IN `riesgo_controlado_probabilidad` VARCHAR(150), IN `riesgo_controlado_impacto` VARCHAR(150), IN `riesgo_controlado_valor` VARCHAR(150), IN `estado` INT, IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_impacto_1` (IN `descripcion` VARCHAR(150), IN `tipo_regla` VARCHAR(150), IN `tipo_valor` VARCHAR(150), IN `comentario` VARCHAR(150), IN `estado` INT, IN `escenario` INT, IN `formula` VARCHAR(150), IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_impacto_2` (IN `descripcion` VARCHAR(150), IN `tipo_regla` VARCHAR(150), IN `tipo_valor` VARCHAR(150), IN `operador1` VARCHAR(150), IN `valor1` INT, IN `operador2` VARCHAR(150), IN `valor2` INT, IN `comentario` VARCHAR(150), IN `estado` INT, IN `escenario` INT, IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_inventario_clasificacion_activo` (IN `idempresa` INT, IN `idarea` INT, IN `idunidad` INT, IN `idmacroproceso` INT, IN `idproceso` INT, IN `activo` VARCHAR(150), IN `desc_activo` VARCHAR(500), IN `idtipo_activo` INT, IN `idcategoria_activo` INT, IN `idubicacion` INT, IN `idpropietario` INT, IN `idcustodio` INT, IN `val_c` INT, IN `val_i` INT, IN `val_d` INT, IN `idvalor` INT, IN `estado` INT, IN `comentario` VARCHAR(500), IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_inventario_clasificacion_activo_historial` (IN `id_ica` INT, IN `idempresa` INT, IN `idarea` INT, IN `idunidad` INT, IN `idmacroproceso` INT, IN `idproceso` INT, IN `activo` VARCHAR(150), IN `desc_activo` VARCHAR(500), IN `idtipo_activo` INT, IN `idcategoria_activo` INT, IN `idubicacion` INT, IN `idpropietario` INT, IN `idcustodio` INT, IN `val_c` INT, IN `val_i` INT, IN `val_d` INT, IN `idvalor` INT, IN `estado` INT, IN `comentario` VARCHAR(500), IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_nivel_riesgo` (IN `descripcion` VARCHAR(150), IN `operador1` VARCHAR(150), IN `valor1` INT, IN `operador2` VARCHAR(150), IN `valor2` INT, IN `color` VARCHAR(150), IN `comentario` VARCHAR(150), IN `estado` INT, IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_probabilidad_1` (IN `descripcion` VARCHAR(150), IN `tipo_regla` VARCHAR(150), IN `tipo_valor` VARCHAR(150), IN `comentario` VARCHAR(150), IN `estado` INT, IN `escenario` INT, IN `formula` INT, IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_probabilidad_2` (IN `descripcion` VARCHAR(150), IN `tipo_regla` VARCHAR(150), IN `tipo_valor` VARCHAR(150), IN `operador1` VARCHAR(150), IN `valor1` INT, IN `operador2` VARCHAR(150), IN `valor2` INT, IN `comentario` VARCHAR(150), IN `estado` INT, IN `escenario` INT, IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_add_tipo_amenaza` (IN `tipo` VARCHAR(150), IN `estado` INT, IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
	insert into tipo_amenaza(tipo,estado,id_user_added,date_add)
	values (tipo,estado,id_user_added,date_add);
END$$

CREATE  PROCEDURE `sp_agregar_plan_accion` (IN `plan_accion` VARCHAR(150), IN `actividades` VARCHAR(150), IN `descripcion` VARCHAR(150), IN `fecha_inicio` DATETIME, IN `fecha_fin` DATETIME, IN `idempresa` INT, IN `idarea` INT, IN `idunidad` INT, IN `idposicion` INT, IN `id_user` INT)   BEGIN
...
CREATE  PROCEDURE `sp_count_evaluacion_by_valor` ()   BEGIN
...
CREATE  PROCEDURE `sp_delete_categoria_vulnerabilidad` (IN `id` INT, IN `id_user_deleted` INT, IN `date_deleted` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_delete_desc_amenaza` (IN `id` INT, IN `id_user_deleted` INT, IN `date_deleted` DATETIME)   BEGIN
	update desc_amenaza
	set is_deleted=1,
	id_user_deleted=id_user_deleted,
	date_deleted=date_deleted
...
CREATE  PROCEDURE `sp_delete_desc_vulnerabilidad` (IN `id` INT, IN `id_user_deleted` INT, IN `date_deleted` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_delete_evaluacion_riesgo` (IN `id` INT, IN `id_user_deleted` INT, IN `date_deleted` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_delete_impacto` (IN `id` INT, IN `id_user_deleted` INT, IN `date_deleted` DATETIME)   BEGIN
	update impacto_riesgo
	set is_deleted=1,estado=2,id_user_deleted=id_user_deleted,date_deleted=date_deleted
	where id=id;
END$$

CREATE  PROCEDURE `sp_delete_inventario_clasificacion_activo` (IN `id` INT, IN `id_user_deleted` INT, IN `date_deleted` DATETIME)   BEGIN
	update inventario_clasificacion_activo
	set is_deleted=1,id_user_deleted=id_user_deleted,date_deleted=date_deleted
	where id=id;
END$$

CREATE  PROCEDURE `sp_delete_nivel_riesgo` (IN `id` INT, IN `id_user_deleted` INT, IN `date_deleted` DATETIME)   BEGIN
	update nivel_riesgo
	set is_deleted=1,
	estado=2,
	id_user_deleted=id_user_deleted,
...
CREATE  PROCEDURE `sp_delete_probabilidad` (IN `id` INT, IN `id_user_deleted` INT, IN `date_deleted` DATETIME)   BEGIN
	update probabilidad_riesgo
	set is_deleted=1,estado=2,id_user_deleted=id_user_deleted,date_deleted=date_deleted
	where id=id;
END$$

CREATE  PROCEDURE `sp_delete_tipo_amenaza` (IN `id` INT, IN `id_user_deleted` INT, IN `date_deleted` DATETIME)   BEGIN
	update tipo_amenaza
	set is_deleted=1,
	estado=2,
	id_user_deleted=id_user_deleted,
...
CREATE  PROCEDURE `sp_delete_tipo_riesgo` (IN `id` INT, IN `id_user_deleted` INT, IN `date_deleted` DATETIME)   BEGIN
	update tipo_riesgo
	set estado=2,is_deleted=1,id_user_deleted=id_user_deleted,date_deleted=date_deleted
	where id=id;
END$$

CREATE  PROCEDURE `sp_editar_plan_accion` (IN `id` INT, IN `plan_accion` VARCHAR(150), IN `actividades` INT, IN `descripcion` VARCHAR(150), IN `fecha_inicio` DATETIME, IN `fecha_fin` DATETIME, IN `idempresa` INT, IN `idarea` INT, IN `idunidad` INT, IN `idposicion` INT, IN `id_user` INT)   BEGIN
	SET @fecha_actual = CURRENT_DATE();
...
CREATE  PROCEDURE `sp_edit_categoria_vulnerabilidad` (IN `id` INT, IN `categoria` VARCHAR(150), IN `estado` INT, IN `id_user_updated` INT, IN `date_modify` DATETIME)   BEGIN
	update categoria_vulnerabilidad
...
CREATE  PROCEDURE `sp_edit_desc_amenaza` (IN `id` INT, IN `idtipo_amenaza` INT, IN `amenaza` VARCHAR(150), IN `id_user_updated` INT, IN `date_modify` DATETIME)   BEGIN
	update desc_amenaza
...
CREATE  PROCEDURE `sp_edit_desc_vulnerabilidad` (IN `id` INT, IN `idcategoria` INT, IN `vulnerabilidad` VARCHAR(150), IN `id_user_updated` INT, IN `date_modify` DATETIME)   BEGIN
	update desc_vulnerabilidad
...
CREATE  PROCEDURE `sp_edit_impacto_1` (IN `idir` INT, IN `iddescripcion` VARCHAR(150), IN `idtipo_regla` VARCHAR(150), IN `idtipo_valor` VARCHAR(150), IN `idcomentario` VARCHAR(150), IN `idestado` INT, IN `idformula` VARCHAR(150), IN `idid_user_updated` INT, IN `iddate_modify` DATETIME)   BEGIN
	update impacto_riesgo
...
CREATE  PROCEDURE `sp_edit_impacto_2` (IN `idir` INT, IN `descripcion` VARCHAR(150), IN `tipo_regla` VARCHAR(150), IN `tipo_valor` VARCHAR(150), IN `operador1` VARCHAR(150), IN `valor1` INT, IN `operador2` VARCHAR(150), IN `valor2` INT, IN `comentario` VARCHAR(150), IN `estado` INT, IN `id_user_updated` INT, IN `date_modify` DATETIME)   BEGIN
	update impacto_riesgo
...
CREATE  PROCEDURE `sp_edit_inventario_clasificacion_activo` (IN `idid` INT, IN `idempresa` INT, IN `idarea` INT, IN `idunidad` INT, IN `idmacroproceso` INT, IN `idproceso` INT, IN `activo` VARCHAR(150), IN `desc_activo` VARCHAR(500), IN `idtipo_activo` INT, IN `idcategoria_activo` INT, IN `idubicacion` INT, IN `idpropietario` INT, IN `idcustodio` INT, IN `val_c` INT, IN `val_i` INT, IN `val_d` INT, IN `idvalor` INT, IN `estado` INT, IN `comentario` VARCHAR(500), IN `id_user_updated` INT, IN `date_modify` DATETIME, IN `observacion` VARCHAR(200))   BEGIN
	update inventario_clasificacion_activo
...
CREATE  PROCEDURE `sp_edit_nivel_riesgo` (IN `id` INT, IN `descripcion` VARCHAR(150), IN `operador1` VARCHAR(150), IN `valor1` INT, IN `operador2` VARCHAR(150), IN `valor2` INT, IN `color` VARCHAR(150), IN `comentario` VARCHAR(150), IN `estado` INT, IN `id_user_updated` INT, IN `date_modify` DATETIME)   BEGIN
	update nivel_riesgo
	set descripcion=descripcion,
	operador1=operador1,
	operador2=operador2,
...
CREATE  PROCEDURE `sp_edit_probabilidad_1` (IN `idpr` INT, IN `iddescripcion` VARCHAR(150), IN `idtipo_regla` VARCHAR(150), IN `idtipo_valor` VARCHAR(150), IN `idcomentario` VARCHAR(150), IN `idestado` INT, IN `idformula` VARCHAR(150), IN `idid_user_updated` INT, IN `iddate_modify` DATETIME)   BEGIN
	update probabilidad_riesgo
	set formula=idformula,
    descripcion=iddescripcion,
    tipo_regla=idtipo_regla,
...
CREATE  PROCEDURE `sp_edit_tipo_amenaza` (IN `id` INT, IN `tipo` VARCHAR(150), IN `estado` INT, IN `id_user_updated` INT, IN `date_modify` DATETIME)   BEGIN
	update tipo_amenaza
	set tipo=tipo,
	estado=estado,
	id_user_updated=id_user_updated,
...
CREATE  PROCEDURE `sp_get_active_escenario_1` ()   BEGIN
	select * from probabilidad_riesgo where estado=1 and is_deleted=0 and escenario=1;
END$$

CREATE  PROCEDURE `sp_get_active_impacto_escenario_1` ()   BEGIN
	select * from impacto_riesgo where estado=1 and is_deleted=0 and escenario=1;
END$$

CREATE  PROCEDURE `sp_get_aplicacion_impacto_by_caracteristica` (IN `caracteristica` VARCHAR(50), IN `escene` INT)   BEGIN
...
CREATE  PROCEDURE `sp_get_aplicacion_probabilidad_by_caracteristica` (IN `idcaracteristica` VARCHAR(50), IN `escene` INT)   BEGIN
...
CREATE  PROCEDURE `sp_get_caracteristica_control_opcion` (IN `scene` INT)   begin
...
CREATE  PROCEDURE `sp_get_evaluacion_riesgo_by_id` (IN `id` INT)   BEGIN
	select * from evaluacion_riesgo where id=id;
END$$

CREATE  PROCEDURE `sp_get_evaluacion_riesgo_controles_by_evaluacion_riesgo_id` (IN `id_evaluacion_riesgo_pass` INT)   begin
	select * from evaluacion_riesgos_controles where id_evaluacion_riesgo = id_evaluacion_riesgo_pass;
end$$

CREATE  PROCEDURE `sp_get_impacto_by_description` (IN `iddescription` VARCHAR(50))   BEGIN
	select * from impacto_riesgo
	where descripcion=iddescription and is_deleted=0;
END$$

CREATE  PROCEDURE `sp_get_info_to_email` (IN `idid` INT)   BEGIN
	select
	ica.id as ica_id,
	ica.activo,
	ica.desc_activo,
...
CREATE  PROCEDURE `sp_get_inventario_clasificacion_activo` (IN `idid` INT)   BEGIN
	select * from inventario_clasificacion_activo where id=idid;
END$$

CREATE  PROCEDURE `sp_get_last_evaluacion_riesgo` ()   begin
	select id from evaluacion_riesgo order by id desc limit 1;
end$$

CREATE  PROCEDURE `sp_get_last_id` ()   BEGIN
	select * from inventario_clasificacion_activo order by id desc limit 1;
END$$

CREATE  PROCEDURE `sp_get_probabilidad_by_description` (IN `iddescription` VARCHAR(50))   BEGIN
	select * from probabilidad_riesgo
	where descripcion=iddescription and is_deleted=0;
END$$

CREATE  PROCEDURE `sp_get_valoracion_riesgo` (IN `idid_probabilidad` INT, IN `idid_impacto` INT)   BEGIN
	select * from valoracion_riesgo where idProbabilidad=idid_probabilidad and idImpacto=idid_impacto and is_deleted=0;
END$$

CREATE  PROCEDURE `sp_get_valor_combinacion_valoracion` (IN `val_c` INT, IN `val_i` INT, IN `val_d` INT)   BEGIN
...
CREATE  PROCEDURE `sp_insert_tipo_riesgo` (IN `tipo_riesgo` VARCHAR(150), IN `descripcion` VARCHAR(150), IN `estado` INT, IN `id_user_added` INT, IN `date_add` DATETIME)   BEGIN
...
CREATE  PROCEDURE `sp_list_categoria_vulnerabilidad` ()   BEGIN
	select * from categoria_vulnerabilidad where is_deleted=0;
END$$

CREATE  PROCEDURE `sp_list_desc_amenaza` ()   BEGIN
	select * from desc_amenaza where is_deleted=0;
END$$

CREATE  PROCEDURE `sp_list_desc_vulnerabilidad` ()   BEGIN
	select * from desc_vulnerabilidad where is_deleted=0;
END$$

CREATE  PROCEDURE `sp_list_evaluacion_riesgo` ()   BEGIN
	select * from evaluacion_riesgo where is_deleted=0;
END$$

CREATE  PROCEDURE `sp_list_evaluacion_riesgo_historial` (IN `idid` INT)   BEGIN
	select
		erh.id as id,
...
CREATE  PROCEDURE `sp_list_ica_by_valoracion` (IN `val_c` INT, IN `val_i` INT, IN `val_d` INT)   BEGIN
	select ica.* from inventario_clasificacion_activo ica
	where ica.val_c=val_c and ica.val_i=val_i and ica.val_d=val_d;
END$$

CREATE  PROCEDURE `sp_list_impacto` (IN `idescenario` INT)   BEGIN
	select * from impacto_riesgo where escenario=idescenario and is_deleted=0;
END$$

CREATE  PROCEDURE `sp_list_inventario_clasificacion_activo` (IN `empresa` INT)   BEGIN
	select
	ica.id as ica_id,
	ica.activo,
	ica.desc_activo,
...
CREATE  PROCEDURE `sp_list_inventario_clasificacion_activo_by_user` (IN `id_user` INT, IN `empresa` INT)   BEGIN
	select
	ica.id as ica_id,
	ica.activo,
	ica.desc_activo,
...
CREATE  PROCEDURE `sp_list_inventario_clasificacion_activo_historial` (IN `idid` INT)   BEGIN
	select
...
CREATE  PROCEDURE `sp_list_inventario_clasificacion_activo_historial_by_user` (IN `id_user` INT, IN `idid` INT)   BEGIN
	select
	ica.id_ica as ica_id,
	ica.activo,
	ica.desc_activo,
...
CREATE  PROCEDURE `sp_list_nivel_riesgo` ()   BEGIN
	select * from nivel_riesgo where is_deleted=0;
END$$

CREATE  PROCEDURE `sp_list_probabilidad` (IN `idescenario` INT)   BEGIN
	select * from probabilidad_riesgo where escenario=idescenario and is_deleted=0;
END$$

CREATE  PROCEDURE `sp_list_tipo_amenaza` ()   BEGIN
	select * from tipo_amenaza where is_deleted=0;
END$$

CREATE  PROCEDURE `sp_list_tipo_riesgo` ()   BEGIN
	select * from tipo_riesgo where is_deleted=0;
END$$

CREATE  PROCEDURE `sp_update_evaluacion_riesgo` (IN `idid` INT, IN `idid_tipo_riesgo` INT, IN `idid_empresa` INT, IN `idid_area` INT, IN `idid_unidad` INT, IN `idid_macroproceso` INT, IN `idid_proceso` INT, IN `idid_activo` INT, IN `idid_tipo_amenaza` INT, IN `idid_descripcion_amenaza` INT, IN `idid_tipo_vulnerabilidad` INT, IN `idid_descripcion_vulnerabilidad` INT, IN `idriesgo` VARCHAR(150), IN `idvalor_probabilidad` INT, IN `idprobabilidad` VARCHAR(150), IN `idvalor_impacto` VARCHAR(150), IN `idimpacto` VARCHAR(150), IN `idvalor` VARCHAR(150), IN `idid_control` INT, IN `idriesgo_controlado_probabilidad` VARCHAR(150), IN `idriesgo_controlado_impacto` VARCHAR(150), IN `idriesgo_controlado_valor` VARCHAR(150), IN `idestado` INT, IN `idid_user_updated` INT, IN `iddate_modify` DATETIME)   BEGIN
	update evaluacion_riesgo
	set 
...
CREATE  PROCEDURE `sp_update_scene_probabilidad_user` (IN `user_id` INT, IN `idscene` INT)   BEGIN
	update escenario_active set escenario=idscene;
END$$

CREATE  PROCEDURE `sp_update_tipo_riesgo` (IN `id` INT, IN `tipo_riesgo` VARCHAR(150), IN `descripcion` VARCHAR(150), IN `estado` INT, IN `id_user_updated` INT, IN `date_modify` DATETIME)   begin
	update tipo_riesgo
...
CREATE  PROCEDURE `sp_validate_combinatoria_impacto` (IN `idoperador1` VARCHAR(150), IN `idvalor1` INT, IN `idoperador2` VARCHAR(150), IN `idvalor2` INT)   begin
	select * from impacto_riesgo
...
CREATE  PROCEDURE `sp_validate_combinatoria_probabilidad` (IN `idoperador1` VARCHAR(150), IN `idvalor1` INT, IN `idoperador2` VARCHAR(150), IN `idvalor2` INT)   begin
	select * from probabilidad_riesgo
	where operador1=idoperador1 and valor1=idvalor1
...
CREATE  PROCEDURE `updateConfigPass` (IN `idduracion` INT, IN `idinactividad` INT, IN `idsesion` INT, IN `idtama_min` INT, IN `idtama_max` INT, IN `idletras` INT, IN `idnumeros` INT, IN `idcaracteres` INT, IN `last_activity` INT, IN `idintentos` INT)   begin
...
CREATE  PROCEDURE `updateEstadoPLan` (IN `idid` INT)   begin
	UPDATE plan_accion SET idestado=2 where id = idid;
end$$

CREATE  PROCEDURE `updateLoged` (IN `dato` INT)   begin
	DELETE FROM tb_sesiones 
        where id_us = dato;
end$$

CREATE  PROCEDURE `update_status_ica` (IN `idid` INT, IN `estado` INT, IN `date_modify` DATETIME, IN `id_user_updated` INT)   begin
	update inventario_clasificacion_activo
	set estado=estado,id_user_updated=id_user_updated,date_modify=date_modify
	where id=idid;
end$$

CREATE  PROCEDURE `update_valor_ica` (IN `id` INT, IN `id_valor` INT)   begin
	update inventario_clasificacion_activo
	set idvalor=id_valor
	where id=id;
end$$

CREATE  PROCEDURE `validaAlerta_seguimiento` (IN `idalert` VARCHAR(50))   begin
	  SELECT * FROM alert_seguimiento where alerta=idalert and is_deleted=0;
end$$

CREATE  PROCEDURE `validaArea` (IN `idarea` VARCHAR(150), IN `empresa` INT)   begin
	select * from area   where idempresa =empresa
    and area=idarea;
end$$

CREATE  PROCEDURE `validaAspecto` (IN `idaspecto` VARCHAR(150))   begin
	 SELECT * FROM aspectos_seguridad where 
         aspecto=idaspecto and is_deleted=0;
end$$

CREATE  PROCEDURE `validaCatActivo` (IN `idcategoria` VARCHAR(150), IN `tipo` INT)   begin
...
CREATE  PROCEDURE `validaClasInfo` (IN `idclasificacion` VARCHAR(150))   begin
SELECT * FROM clasificacion_informacion 
            where clasificacion=idclasificacion and
            is_deleted=0;
end$$

CREATE  PROCEDURE `validaEmpresa` (IN `idempresa` VARCHAR(150))   begin
	select * from empresa  where empresa =idempresa and is_deleted=0;
end$$

CREATE  PROCEDURE `validaEstado` (IN `idestado` VARCHAR(50))   begin
	  SELECT * FROM estado where estado=idestado and is_deleted=0;
end$$

CREATE  PROCEDURE `validaMacroproceso` (IN `area` INT, IN `empresa` INT, IN `unidad` INT, IN `idmacroproceso` VARCHAR(150))   begin
...
CREATE  PROCEDURE `validaPlanAccion` (IN `idplan_accion` VARCHAR(150))   begin
	  SELECT * FROM plan_accion where plan_accion=idplan_accion and is_deleted=0;
end$$

CREATE  PROCEDURE `validaPosicion` (IN `area` INT, IN `empresa` INT, IN `unidad` INT, IN `idposicion` VARCHAR(150))   begin
...
CREATE  PROCEDURE `validaPrioridad` (IN `idprioridad` VARCHAR(150))   begin
	select * from prioridad where prioridad=idprioridad and is_deleted=0;
end$$

CREATE  PROCEDURE `validaProceso` (IN `area` INT, IN `empresa` INT, IN `unidad` INT, IN `macroproceso` INT, IN `idproceso` VARCHAR(150))   begin
...
CREATE  PROCEDURE `validaRegistroControl` (IN `dato` INT)   begin
select * from registro_controles 
        where is_deleted=0 and nom_control=dato;
end$$

CREATE  PROCEDURE `validaTipoActivo` (IN `idtipo` VARCHAR(150))   begin
	SELECT * FROM tipo_activo 
            where tipo=idtipo and
            is_deleted=0;
end$$

CREATE  PROCEDURE `validaUbiActivo` (IN `idcontinente` VARCHAR(50), IN `idpais` VARCHAR(50), IN `idciudad` VARCHAR(50), IN `iddireccion` VARCHAR(300), IN `iddescripcion` VARCHAR(300))   begin
...
CREATE  PROCEDURE `validaUnidad` (IN `idarea` INT, IN `idempresa` INT, IN `idunidad` VARCHAR(150))   begin
	SELECT * FROM unidades where 
          idempresa=idempresa and
		idarea = idarea and unidad=idunidad;
end$$

CREATE  PROCEDURE `validaValoracionActivo` (IN `idaspecto1` INT, IN `idaspecto2` INT, IN `idaspecto3` INT, IN `idvaloracion1` INT, IN `idvaloracion2` INT, IN `idvaloracion3` INT, IN `ididvalor` INT)   begin
...
CREATE  PROCEDURE `validaValorActivo` (IN `idvalor` VARCHAR(150))   begin
	 SELECT * FROM valor_activo where 
         valor=idvalor and is_deleted=0;
end$$

CREATE  PROCEDURE `valida_AplicacionImpacto` (IN `iddisenio` INT, IN `idposicion` VARCHAR(50), IN `idescenario` INT)   begin
	 SELECT *
...
CREATE  PROCEDURE `valida_AplicacionProbabilidad` (IN `iddisenio` INT, IN `idposicion` VARCHAR(50), IN `idescenario` INT)   begin
	SELECT *
	FROM aplicacion_probailidad where idclasificacion=iddisenio and 
	posicion=idposicion and escenario=idescenario and is_deleted=0;
end$$

CREATE  PROCEDURE `valida_caractControl` (IN `idcaracteristica` VARCHAR(50), IN `ididOpcion` INT)   begin
	SELECT *
	FROM caracteristica_control where caracteristica=idcaracteristica and idOpcion=ididOpcion and is_deleted=0 ;
end$$

CREATE  PROCEDURE `valida_cobertura` (IN `idcobertura` VARCHAR(150))   begin
	SELECT * FROM cobertura where cobertura=idcobertura and is_deleted=0;
end$$

CREATE  PROCEDURE `valida_Evaluacion_Control` (IN `disenio` INT, IN `operatividad` INT, IN `calificacion` VARCHAR(50))   begin
	SELECT *
...
CREATE  PROCEDURE `valida_ValoracionRiesgo` (IN `probabilidad` INT, IN `impacto` INT)   begin
	  SELECT *
...
(3, 'Operatividad', 'Operatividad', 1, 5, '2023-03-24 00:00:00.000000', NULL, NULL, NULL, NULL, 0, '', '', '', 'menu', 0, 0, 0, '', 1),
(4, 'Definición', 'Definición', 1, 5, '2023-03-24 00:00:00.000000', NULL, NULL, NULL, NULL, 0, '', '', '', 'submenu', 1, 0, 0, '', 0),
(5, 'Objetivo', 'Objetivo', 1, 5, '2023-03-24 00:00:00.000000', 5, '2023-03-27 00:00:00.000000', NULL, NULL, 0, '', '', '', 'submenu', 1, 0, 0, '', 1),
...
(22, 'Prueba', 'Prueba', 1, 5, '2023-03-27 00:00:00.000000', NULL, NULL, NULL, NULL, 0, '', '', '', 'submenu', 3, 0, 0, '', 0),
...
(2, 'Bajo', '>', 0, '<', 15000, '#000000', 'Bajo', 1, 5, '2023-03-27 11:48:49.000000', NULL, NULL, NULL, NULL, 0);
...
(1, 'Rh Proceso', 1, 12, 11, 8, 1, 5, '2023-03-24 02:26:19.000000', 5, '2023-03-24 02:27:13.000000', NULL, NULL, 0),
(2, 'Proceso RH', 1, 13, 14, 10, 2, 5, '2023-03-26 16:52:09.000000', NULL, NULL, NULL, NULL, 0),
...
(5, '', 'admin', 'admin', 'admin', 'youkai.miguel@gmail.com', 'admin', '2023-03-22 00:41:33.000000', '2023-03-27 10:39:39.000000', 1, 1, 0, 1, NULL, 11, 12, 4, 15, 11, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
...
--
ALTER TABLE `tb_sesiones`
  MODIFY `id_se` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
