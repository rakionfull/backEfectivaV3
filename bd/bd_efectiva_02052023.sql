...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2023 a las 10:33:48
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_opcion` (IN `id_perfil` INT)   BEGIN
    SELECT * FROM tb_detalle_perfil AS DP
    INNER JOIN tb_opcion AS T ON DP.id = T.id_op
    WHERE DP.tabla = 'tb_opcion' AND DP.id_perfil = id_perfil;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_user_by_empresa` (IN `empresa_id` INT, IN `area_id` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `obtenerModulosPerfil` (IN `perfil_id` INT)   BEGIN
    SELECT DP.*, TM.* FROM tb_detalle_perfil AS DP
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_update_user_estado` (IN `id_us` INT, IN `estado_us` INT)   BEGIN
    UPDATE tb_users
...
(1, 'ADMINISTRADOR', 'ADMINISTRADOR DEL SISTEMA', 1, '2023-05-01 20:40:38.000000', '2023-05-01 23:39:15.000000', NULL, NULL, NULL, NULL, NULL, NULL, 0, 1);
...
(1, '33333333', 'testeoBB', 'testeoBB', 'testeoBB', 'youkai.miguel@gmail.com', 'administrador', '2023-05-01 20:46:14.000000', '2023-05-02 00:19:23.000000', 1, 1, 0, 1, NULL, 1, 0, 0, 0, 0, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL),
(3, '33333333', 'testeoBB', 'testeoBB', 'testeoBB', 'youkai.miguel@gmail.com', 'testeo1', '2023-05-01 21:02:46.000000', '2023-05-02 00:19:23.000000', 1, 1, 1, 1, NULL, 1, 0, 0, 0, 0, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL),
(4, '33333333', 'testeoBB', 'testeoBB', 'testeoBB', 'youkai.miguel@gmail.com', 'testeo2', '2023-05-02 00:19:04.000000', '2023-05-02 00:19:23.000000', 1, 4, 1, 1, NULL, 1, 0, 0, 0, 0, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `tb_detalle_perfil`
  MODIFY `id_det_per` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
